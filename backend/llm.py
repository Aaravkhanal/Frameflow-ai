...
# NVIDIA NIM model API names (passed verbatim to the NVIDIA endpoint)
NVIDIA_MODEL_API_NAME: dict[Llm, str] = {
    Llm.GLM_5_2: "z-ai/glm-5.2",
    Llm.KIMI_K2_6: "moonshotai/kimi-k2.6",
}
