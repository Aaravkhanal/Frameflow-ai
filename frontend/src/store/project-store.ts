...
import { PromptAsset, OrchestrationEventData } from "../types";
...
interface ProjectStore {
  ...
  orchestrationEvents: OrchestrationEventData[];
  appendOrchestrationEvent: (event: OrchestrationEventData) => void;
  resetOrchestrationEvents: () => void;
}
...
export const useProjectStore = create<ProjectStore>((set) => ({
  ...
  orchestrationEvents: [],
  appendOrchestrationEvent: (event) => set((state) => ({
    orchestrationEvents: [...state.orchestrationEvents, event]
  })),
  resetOrchestrationEvents: () => set({ orchestrationEvents: [] }),
}));
